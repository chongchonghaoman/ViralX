...
## 原片结构母版
按原片时间顺序列出每个段落的起止时间、镜头 ID、画面动作、叙事功能、字幕/声音功能、光线/效果、转场与 CTA；每行附 [SHOT:Sxxx]。无法确认的字段写“未采集”。

## 高保真复刻执行脚本
执行目标：在不复制原作者具体人物、品牌与受保护素材的前提下，尽可能复现原片已经验证的结构、节奏与视觉效果；这不是自由创意延伸。

先给出“必须保留 / 可以替换 / 禁止新增”三栏清单，再用表格逐段输出：原片时间段与镜头引用、目标片时间段、镜头景别与机位/运镜、画面动作、目标产品替换、台词/字幕、声音、光线/视觉效果、转场、CTA、执行备注。目标片段顺序应与原片一致，总时长和各段时长比例尽量贴近原片；任何调整必须说明原因。"""
...
## 原片结构母版
按原片时间顺序列出每个段落的起止时间、画面动作、叙事功能、字幕/声音功能、光线/效果、转场与 CTA；每行引用 [VIDEO:MM:SS-MM:SS]，有对应镜头时追加 [SHOT:Sxxx]。

## 高保真复刻执行脚本
执行目标：在不复制原作者具体人物、品牌与受保护素材的前提下，尽可能复现原片已经验证的结构、节奏与视觉效果；这不是自由创意延伸。

先给出“必须保留 / 可以替换 / 禁止新增”三栏清单，再用表格逐段输出：原片时间段与证据引用、目标片时间段、镜头景别与机位/运镜、画面动作、目标产品替换、台词/字幕、声音、光线/视觉效果、转场、CTA、执行备注。目标片段顺序应与原片一致，总时长和各段时长比例尽量贴近原片；任何调整必须说明原因。"""

...
- Preserve the TikTok search boundary: keyword discovery uses API23 first and automatically falls back to Scraper7 with the same RapidAPI Key; direct video URLs skip discovery and continue through TK Note / yt-dlp.
